...
import FeederMonthlyReport from "../AE_Pages/FeederMonthlyReport";

const FeederReadingScreen = () => {
    return(
        <>
    <div className='container'>
        ...
        <div className='chart'><FeederMonthlyReport /></div>
    </div>
     </>
    );
}

export default FeederReadingScreen;